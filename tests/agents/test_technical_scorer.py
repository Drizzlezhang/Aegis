...
class TestTechnicalScoreBreakdown:
    def test_total_calculation(self):
        score = TechnicalScoreBreakdown(
            trend_score=30, deviation_score=20, volume_score=15,
            support_score=10, macd_score=15, rsi_score=10,
        )
    ...
    def test_grade_b(self):
        score = TechnicalScoreBreakdown(
            trend_score=20, deviation_score=15, volume_score=10,
            support_score=10, macd_score=10, rsi_score=5,
        )
    ...
    def test_grade_c(self):
        score = TechnicalScoreBreakdown(
            trend_score=15, deviation_score=10, volume_score=10,
            support_score=5, macd_score=8, rsi_score=5,
        )
    ...
    def test_grade_d(self):
        score = TechnicalScoreBreakdown(
            trend_score=10, deviation_score=10, volume_score=5,
    ...
    def test_grade_f(self):
        score = TechnicalScoreBreakdown(
            trend_score=5, deviation_score=5, volume_score=5,
            support_score=0, macd_score=5, rsi_score=3,
        )
    ...
    def test_grade_boundary_80_is_a(self):
        score = TechnicalScoreBreakdown(
            trend_score=30, deviation_score=20, volume_score=15,
            support_score=10, macd_score=5, rsi_score=0,
        )
    ...
    def test_grade_boundary_65_is_b(self):
        score = TechnicalScoreBreakdown(
            trend_score=30, deviation_score=20, volume_score=10,
            support_score=5, macd_score=0, rsi_score=0,
        )
...
class TestTechnicalScorerTrend:
    ...
    async def test_full_trend_bullish(self):
        """SMA50 > SMA200 + Price > SMA50 + ADX > 25 → trend=30."""
        ...
        assert result.data.trend_score == 30.0
...
class TestTechnicalScorerDeviation:
    ...
    async def test_perfect_deviation_zero_pct(self):
        ...
        assert result.success
        assert result.data.deviation_score == 20.0
...
class TestTechnicalScorerFullScore:
    ...
    async def test_max_score_scenario(self):
        ...
        skill = TechnicalScorerSkill()
        indicators = {
            "sma50": 200, "sma200": 180, "close": 210, "adx": 30,  # trend=30
            "relative_volume": 2.0, "obv_aligned": True,  # volume=15
            "macd": 1.5, "macd_signal": 1.0, "macd_histogram_expanding": True,  # macd=15
            "rsi": 35,  # rsi=10
        }
        # deviation: price=sma50=200 → 0% → 20
        indicators["sma50"] = 200
